        ...
        <CardHeader
          ...
          action={
            <Box>
              ...
              <IconButton onClick={fetchCourses} sx={styles.refreshButton}>
                  ...
                  >
                    ...
                    <CardContent sx={{ flexGrow: 1 }}>
                      ...
                      <Typography variant="body2" color="text.secondary">
                        <strong>Prof.</strong>{" "}
                        {course.profesor?.nombre || "Sin asignar"}
                      </Typography>
                      <Typography
                        variant="body2"
            ...
            <DialogContent sx={{ py: 4 }}>
              <Box
                sx={{
                  height: 200,
                  backgroundColor: theme.primary, // Changed from theme.palette.primary.main
                  backgroundImage: selectedCourse.imagen_url
                    ? `url(${selectedCourse.imagen_url})`
                    : "none",
                  backgroundSize: "cover",
                  backgroundPosition: "center",
                  borderRadius: 2,
              ...
              <Typography paragraph>{selectedCourse.descripcion}</Typography>
